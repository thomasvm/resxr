...
namespace Resxr
{
    public class Program
    {
        ...
        private static string GetStronglyTypeCsFileForResx(string xmlPath, string moduleName, string className, string accessModifier)
        {
            ...
            string bodyCode = string.Format(BODY, className, moduleName, entries.ToString(), className, accessModifier, accessModifier.Equals("public", StringComparison.InvariantCultureIgnoreCase) ? "public." : string.Empty);
        ...
        public static global::System.Resources.ResourceManager ResourceManager {{
            get {{
                if (object.ReferenceEquals(resourceMan, null)) {{
                    global::System.Resources.ResourceManager temp = new global::System.Resources.ResourceManager(""{1}.Resources"", typeof(Resources).Assembly);
                    resourceMan = temp;
                }}
                return resourceMan;
            }}
